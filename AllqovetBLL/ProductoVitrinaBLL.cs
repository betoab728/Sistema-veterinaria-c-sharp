...
{
    public class ProductoVitrinaBLL : IProductoVitrina,IDisposable
    {
        ProductoVitrinaDAO db = new ProductoVitrinaDAO();
        public int ActualizaStockEntrada(ProductoVitrina productoVitrinaa, ref MySqlConnection con, ref MySqlTransaction transaction)
        {
